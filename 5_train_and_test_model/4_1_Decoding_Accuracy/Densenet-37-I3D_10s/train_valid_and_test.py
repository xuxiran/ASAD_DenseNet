...
# ---------------------if I3D, train and valid the model_2D-----------
    ...
    train_loader = DataLoader(dataset=train_dataset, batch_size=cfg.batch_size//8, shuffle=True)
    valid_loader = DataLoader(dataset=valid_dataset, batch_size=cfg.batch_size//8, shuffle=True)
