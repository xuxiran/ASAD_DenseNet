...
class CNN_2D(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 5, kernel_size=5, stride=1)
        self.fc1 = nn.Linear(in_features=5*7*6, out_features=5)
        self.sigmoid = nn.Sigmoid()
        self.fc2 = nn.Linear(in_features=5, out_features=2)
...
class DenseNet_37(nn.Module):
    def __init__(self,channel_num=16):
        super(DenseNet_37, self).__init__()
