...
# input size:
# eeg = torch.randn(2, 128, 10, 11)
# 2 -> batch size
# 128: time points of eeg, the sampling rate of EEG is 128, so it corresponds to 1 second
# 10,11: width and height of 2D-eeg channel

# please cite this paper
'''
@inproceedings{Xu_Wang_Yan_Wu_Chen_2024, 
